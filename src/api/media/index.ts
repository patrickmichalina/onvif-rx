...
export * from './GetVideoSources'
export * from './GetAudioSources'
export * from './GetAudioOutputs'
export * from './CreateProfile'
export * from './GetProfile'
export * from './GetProfiles'
export * from './AddVideoEncoderConfiguration'
export * from './RemoveVideoEncoderConfiguration'
export * from './AddVideoSourceConfiguration'
export * from './RemoveVideoSourceConfiguration'
export * from './AddAudioEncoderConfiguration'
export * from './RemoveAudioEncoderConfiguration'
export * from './AddAudioSourceConfiguration'
export * from './RemoveAudioSourceConfiguration'
export * from './AddPTZConfiguration'
export * from './RemovePTZConfiguration'
export * from './AddVideoAnalyticsConfiguration'
export * from './RemoveVideoAnalyticsConfiguration'
export * from './AddMetadataConfiguration'
export * from './RemoveMetadataConfiguration'
export * from './AddAudioOutputConfiguration'
export * from './RemoveAudioOutputConfiguration'
export * from './AddAudioDecoderConfiguration'
export * from './RemoveAudioDecoderConfiguration'
export * from './DeleteProfile'
export * from './GetVideoSourceConfigurations'
export * from './GetVideoEncoderConfigurations'
export * from './GetAudioSourceConfigurations'
export * from './GetAudioEncoderConfigurations'
export * from './GetVideoAnalyticsConfigurations'
export * from './GetMetadataConfigurations'
export * from './GetAudioOutputConfigurations'
export * from './GetAudioDecoderConfigurations'
export * from './GetVideoSourceConfiguration'
export * from './GetVideoEncoderConfiguration'
export * from './GetAudioSourceConfiguration'
export * from './GetAudioEncoderConfiguration'
export * from './GetVideoAnalyticsConfiguration'
export * from './GetMetadataConfiguration'
export * from './GetAudioOutputConfiguration'
export * from './GetAudioDecoderConfiguration'
export * from './GetCompatibleVideoEncoderConfigurations'
export * from './GetCompatibleVideoSourceConfigurations'
export * from './GetCompatibleAudioEncoderConfigurations'
export * from './GetCompatibleAudioSourceConfigurations'
export * from './GetCompatibleVideoAnalyticsConfigurations'
export * from './GetCompatibleMetadataConfigurations'
export * from './GetCompatibleAudioOutputConfigurations'
export * from './GetCompatibleAudioDecoderConfigurations'
export * from './SetVideoSourceConfiguration'
export * from './SetVideoEncoderConfiguration'
export * from './SetAudioSourceConfiguration'
export * from './SetAudioEncoderConfiguration'
export * from './SetVideoAnalyticsConfiguration'
export * from './SetMetadataConfiguration'
export * from './SetAudioOutputConfiguration'
export * from './SetAudioDecoderConfiguration'
export * from './GetVideoSourceConfigurationOptions'
export * from './GetVideoEncoderConfigurationOptions'
export * from './GetAudioSourceConfigurationOptions'
export * from './GetAudioEncoderConfigurationOptions'
export * from './GetMetadataConfigurationOptions'
export * from './GetAudioOutputConfigurationOptions'
export * from './GetAudioDecoderConfigurationOptions'
export * from './GetGuaranteedNumberOfVideoEncoderInstances'
export * from './GetStreamUri'
export * from './StartMulticastStreaming'
export * from './StopMulticastStreaming'
export * from './SetSynchronizationPoint'
export * from './GetSnapshotUri'
export * from './GetVideoSourceModes'
export * from './SetVideoSourceMode'
export * from './GetOSDs'
export * from './GetOSD'
export * from './GetOSDOptions'
export * from './SetOSD'
export * from './CreateOSD'
export * from './DeleteOSD'

import { GetServiceCapabilities } from './GetServiceCapabilities'
import { GetVideoSources } from './GetVideoSources'
import { GetAudioSources } from './GetAudioSources'
import { GetAudioOutputs } from './GetAudioOutputs'
import { CreateProfile } from './CreateProfile'
import { GetProfile } from './GetProfile'
import { GetProfiles } from './GetProfiles'
import { AddVideoEncoderConfiguration } from './AddVideoEncoderConfiguration'
import { RemoveVideoEncoderConfiguration } from './RemoveVideoEncoderConfiguration'
import { AddVideoSourceConfiguration } from './AddVideoSourceConfiguration'
import { RemoveVideoSourceConfiguration } from './RemoveVideoSourceConfiguration'
import { AddAudioEncoderConfiguration } from './AddAudioEncoderConfiguration'
import { RemoveAudioEncoderConfiguration } from './RemoveAudioEncoderConfiguration'
import { AddAudioSourceConfiguration } from './AddAudioSourceConfiguration'
import { RemoveAudioSourceConfiguration } from './RemoveAudioSourceConfiguration'
import { AddPTZConfiguration } from './AddPTZConfiguration'
import { RemovePTZConfiguration } from './RemovePTZConfiguration'
import { AddVideoAnalyticsConfiguration } from './AddVideoAnalyticsConfiguration'
import { RemoveVideoAnalyticsConfiguration } from './RemoveVideoAnalyticsConfiguration'
import { AddMetadataConfiguration } from './AddMetadataConfiguration'
import { RemoveMetadataConfiguration } from './RemoveMetadataConfiguration'
import { AddAudioOutputConfiguration } from './AddAudioOutputConfiguration'
import { RemoveAudioOutputConfiguration } from './RemoveAudioOutputConfiguration'
import { AddAudioDecoderConfiguration } from './AddAudioDecoderConfiguration'
import { RemoveAudioDecoderConfiguration } from './RemoveAudioDecoderConfiguration'
import { DeleteProfile } from './DeleteProfile'
import { GetVideoSourceConfigurations } from './GetVideoSourceConfigurations'
import { GetVideoEncoderConfigurations } from './GetVideoEncoderConfigurations'
import { GetAudioSourceConfigurations } from './GetAudioSourceConfigurations'
import { GetAudioEncoderConfigurations } from './GetAudioEncoderConfigurations'
import { GetVideoAnalyticsConfigurations } from './GetVideoAnalyticsConfigurations'
import { GetMetadataConfigurations } from './GetMetadataConfigurations'
import { GetAudioOutputConfigurations } from './GetAudioOutputConfigurations'
import { GetAudioDecoderConfigurations } from './GetAudioDecoderConfigurations'
import { GetVideoSourceConfiguration } from './GetVideoSourceConfiguration'
import { GetVideoEncoderConfiguration } from './GetVideoEncoderConfiguration'
import { GetAudioSourceConfiguration } from './GetAudioSourceConfiguration'
import { GetAudioEncoderConfiguration } from './GetAudioEncoderConfiguration'
import { GetVideoAnalyticsConfiguration } from './GetVideoAnalyticsConfiguration'
import { GetMetadataConfiguration } from './GetMetadataConfiguration'
import { GetAudioOutputConfiguration } from './GetAudioOutputConfiguration'
import { GetAudioDecoderConfiguration } from './GetAudioDecoderConfiguration'
import { GetCompatibleVideoEncoderConfigurations } from './GetCompatibleVideoEncoderConfigurations'
import { GetCompatibleVideoSourceConfigurations } from './GetCompatibleVideoSourceConfigurations'
import { GetCompatibleAudioEncoderConfigurations } from './GetCompatibleAudioEncoderConfigurations'
import { GetCompatibleAudioSourceConfigurations } from './GetCompatibleAudioSourceConfigurations'
import { GetCompatibleVideoAnalyticsConfigurations } from './GetCompatibleVideoAnalyticsConfigurations'
import { GetCompatibleMetadataConfigurations } from './GetCompatibleMetadataConfigurations'
import { GetCompatibleAudioOutputConfigurations } from './GetCompatibleAudioOutputConfigurations'
import { GetCompatibleAudioDecoderConfigurations } from './GetCompatibleAudioDecoderConfigurations'
import { SetVideoSourceConfiguration } from './SetVideoSourceConfiguration'
import { SetVideoEncoderConfiguration } from './SetVideoEncoderConfiguration'
import { SetAudioSourceConfiguration } from './SetAudioSourceConfiguration'
import { SetAudioEncoderConfiguration } from './SetAudioEncoderConfiguration'
import { SetVideoAnalyticsConfiguration } from './SetVideoAnalyticsConfiguration'
import { SetMetadataConfiguration } from './SetMetadataConfiguration'
import { SetAudioOutputConfiguration } from './SetAudioOutputConfiguration'
import { SetAudioDecoderConfiguration } from './SetAudioDecoderConfiguration'
import { GetVideoSourceConfigurationOptions } from './GetVideoSourceConfigurationOptions'
import { GetVideoEncoderConfigurationOptions } from './GetVideoEncoderConfigurationOptions'
import { GetAudioSourceConfigurationOptions } from './GetAudioSourceConfigurationOptions'
import { GetAudioEncoderConfigurationOptions } from './GetAudioEncoderConfigurationOptions'
import { GetMetadataConfigurationOptions } from './GetMetadataConfigurationOptions'
import { GetAudioOutputConfigurationOptions } from './GetAudioOutputConfigurationOptions'
import { GetAudioDecoderConfigurationOptions } from './GetAudioDecoderConfigurationOptions'
import { GetGuaranteedNumberOfVideoEncoderInstances } from './GetGuaranteedNumberOfVideoEncoderInstances'
import { GetStreamUri } from './GetStreamUri'
import { StartMulticastStreaming } from './StartMulticastStreaming'
import { StopMulticastStreaming } from './StopMulticastStreaming'
import { SetSynchronizationPoint } from './SetSynchronizationPoint'
import { GetSnapshotUri } from './GetSnapshotUri'
import { GetVideoSourceModes } from './GetVideoSourceModes'
import { SetVideoSourceMode } from './SetVideoSourceMode'
import { GetOSDs } from './GetOSDs'
import { GetOSD } from './GetOSD'
import { GetOSDOptions } from './GetOSDOptions'
import { SetOSD } from './SetOSD'
...
export const ONVIF_Media_API = (config: IDeviceConfig): IONVIFMediaApi => {
  return {
    ...
    GetVideoSources: () => GetVideoSources().run(config),
    GetAudioSources: () => GetAudioSources().run(config),
    GetAudioOutputs: () => GetAudioOutputs().run(config),
    CreateProfile: () => CreateProfile().run(config),
    GetProfile: () => GetProfile().run(config),
    GetProfiles: () => GetProfiles().run(config),
    AddVideoEncoderConfiguration: () => AddVideoEncoderConfiguration().run(config),
    RemoveVideoEncoderConfiguration: () => RemoveVideoEncoderConfiguration().run(config),
    AddVideoSourceConfiguration: () => AddVideoSourceConfiguration().run(config),
    RemoveVideoSourceConfiguration: () => RemoveVideoSourceConfiguration().run(config),
    AddAudioEncoderConfiguration: () => AddAudioEncoderConfiguration().run(config),
    RemoveAudioEncoderConfiguration: () => RemoveAudioEncoderConfiguration().run(config),
    AddAudioSourceConfiguration: () => AddAudioSourceConfiguration().run(config),
    RemoveAudioSourceConfiguration: () => RemoveAudioSourceConfiguration().run(config),
    AddPTZConfiguration: () => AddPTZConfiguration().run(config),
    RemovePTZConfiguration: () => RemovePTZConfiguration().run(config),
    AddVideoAnalyticsConfiguration: () => AddVideoAnalyticsConfiguration().run(config),
    RemoveVideoAnalyticsConfiguration: () => RemoveVideoAnalyticsConfiguration().run(config),
    AddMetadataConfiguration: () => AddMetadataConfiguration().run(config),
    RemoveMetadataConfiguration: () => RemoveMetadataConfiguration().run(config),
    AddAudioOutputConfiguration: () => AddAudioOutputConfiguration().run(config),
    RemoveAudioOutputConfiguration: () => RemoveAudioOutputConfiguration().run(config),
    AddAudioDecoderConfiguration: () => AddAudioDecoderConfiguration().run(config),
    RemoveAudioDecoderConfiguration: () => RemoveAudioDecoderConfiguration().run(config),
    DeleteProfile: () => DeleteProfile().run(config),
    GetVideoSourceConfigurations: () => GetVideoSourceConfigurations().run(config),
    GetVideoEncoderConfigurations: () => GetVideoEncoderConfigurations().run(config),
    GetAudioSourceConfigurations: () => GetAudioSourceConfigurations().run(config),
    GetAudioEncoderConfigurations: () => GetAudioEncoderConfigurations().run(config),
    GetVideoAnalyticsConfigurations: () => GetVideoAnalyticsConfigurations().run(config),
    GetMetadataConfigurations: () => GetMetadataConfigurations().run(config),
    GetAudioOutputConfigurations: () => GetAudioOutputConfigurations().run(config),
    GetAudioDecoderConfigurations: () => GetAudioDecoderConfigurations().run(config),
    GetVideoSourceConfiguration: () => GetVideoSourceConfiguration().run(config),
    GetVideoEncoderConfiguration: () => GetVideoEncoderConfiguration().run(config),
    GetAudioSourceConfiguration: () => GetAudioSourceConfiguration().run(config),
    GetAudioEncoderConfiguration: () => GetAudioEncoderConfiguration().run(config),
    GetVideoAnalyticsConfiguration: () => GetVideoAnalyticsConfiguration().run(config),
    GetMetadataConfiguration: () => GetMetadataConfiguration().run(config),
    GetAudioOutputConfiguration: () => GetAudioOutputConfiguration().run(config),
    GetAudioDecoderConfiguration: () => GetAudioDecoderConfiguration().run(config),
    GetCompatibleVideoEncoderConfigurations: () => GetCompatibleVideoEncoderConfigurations().run(config),
    GetCompatibleVideoSourceConfigurations: () => GetCompatibleVideoSourceConfigurations().run(config),
    GetCompatibleAudioEncoderConfigurations: () => GetCompatibleAudioEncoderConfigurations().run(config),
    GetCompatibleAudioSourceConfigurations: () => GetCompatibleAudioSourceConfigurations().run(config),
    GetCompatibleVideoAnalyticsConfigurations: () => GetCompatibleVideoAnalyticsConfigurations().run(config),
    GetCompatibleMetadataConfigurations: () => GetCompatibleMetadataConfigurations().run(config),
    GetCompatibleAudioOutputConfigurations: () => GetCompatibleAudioOutputConfigurations().run(config),
    GetCompatibleAudioDecoderConfigurations: () => GetCompatibleAudioDecoderConfigurations().run(config),
    SetVideoSourceConfiguration: () => SetVideoSourceConfiguration().run(config),
    SetVideoEncoderConfiguration: () => SetVideoEncoderConfiguration().run(config),
    SetAudioSourceConfiguration: () => SetAudioSourceConfiguration().run(config),
    SetAudioEncoderConfiguration: () => SetAudioEncoderConfiguration().run(config),
    SetVideoAnalyticsConfiguration: () => SetVideoAnalyticsConfiguration().run(config),
    SetMetadataConfiguration: () => SetMetadataConfiguration().run(config),
    SetAudioOutputConfiguration: () => SetAudioOutputConfiguration().run(config),
    SetAudioDecoderConfiguration: () => SetAudioDecoderConfiguration().run(config),
    GetVideoSourceConfigurationOptions: () => GetVideoSourceConfigurationOptions().run(config),
    GetVideoEncoderConfigurationOptions: () => GetVideoEncoderConfigurationOptions().run(config),
    GetAudioSourceConfigurationOptions: () => GetAudioSourceConfigurationOptions().run(config),
    GetAudioEncoderConfigurationOptions: () => GetAudioEncoderConfigurationOptions().run(config),
    GetMetadataConfigurationOptions: () => GetMetadataConfigurationOptions().run(config),
    GetAudioOutputConfigurationOptions: () => GetAudioOutputConfigurationOptions().run(config),
    GetAudioDecoderConfigurationOptions: () => GetAudioDecoderConfigurationOptions().run(config),
    GetGuaranteedNumberOfVideoEncoderInstances: () => GetGuaranteedNumberOfVideoEncoderInstances().run(config),
    GetStreamUri: () => GetStreamUri().run(config),
    StartMulticastStreaming: () => StartMulticastStreaming().run(config),
    StopMulticastStreaming: () => StopMulticastStreaming().run(config),
    SetSynchronizationPoint: () => SetSynchronizationPoint().run(config),
    GetSnapshotUri: () => GetSnapshotUri().run(config),
    GetVideoSourceModes: () => GetVideoSourceModes().run(config),
    SetVideoSourceMode: () => SetVideoSourceMode().run(config),
    GetOSDs: () => GetOSDs().run(config),
    GetOSD: () => GetOSD().run(config),
    GetOSDOptions: () => GetOSDOptions().run(config),
    SetOSD: () => SetOSD().run(config),
    CreateOSD: () => CreateOSD().run(config),
    DeleteOSD: () => DeleteOSD().run(config),
  }
}